...
include 'header.php';
 ...
 <div class="container-sm">
	<fieldset>
		...
		<br>Cv = коефіцієнт у формулі швидкості різання, яка допускається ріжучими властивостями свердла:
   		...
   		<br>
   		<br>qv = показник степені у формулі швидкості різання, яка допускається ріжучими властивостями свердла:
   		<br><select  id="Qv">
   			<optgroup label="Обробка матеріалу сталь конструкційна з межою міцності 750 Мпа шляхлом свердління, де матеріал ріжучого інструмента - Р18 при умовах обробки менше 0,2 мм/об">
   		...
   		<br>
   		<br>mv = показник степені у формулі швидкості різання, яка допускається ріжучими властивостями свердла:
   		<br><select  id="Mv">
   			<optgroup label="Обробка матеріалу сталь конструкційна з межою міцності 750 Мпа шляхлом свердління, де матеріал ріжучого інструмента - Р18 при умовах обробки менше 0,2 мм/об">
   		...
   		<br>
   		<br>yv = показник степені у формулі швидкості різання, яка допускається ріжучими властивостями свердла:
   		<br><select  id="Yv">
   			<optgroup label="Обробка матеріалу сталь конструкційна з межою міцності 750 Мпа шляхлом свердління, де матеріал ріжучого інструмента - Р18 при умовах обробки менше 0,2 мм/об">
   		...
   		<br>
  	 <br>D,мм = діаметр ріжучого інструменту:
      <br><input  type="number" id="D">
   		<br><br>S0,мм/об = Подача:
   		<br><input  type="number" id="So">     
   		<br><br>T,хв = стійкість ріжучого інструменту при обробці сталі конструкційної і стального лиття матеріалом ріжучої частини інструменту - швидкоріжуча сталь шляхом свердління і розсвердлювання:
   		<br>
   		<select  id="T"> 
  		...
  		<br>
  		<br>Kv = поправочний коефіцієнт,який враховує вплив механічних властивостей оброблювального матеріалу на швидкість різання:<br><input  type="number" id="Kv">  
  		<p id="empty_formula5">
  ...
  <br>
	<fieldset>
	   ...
	   D,мм = діаметр ріжучого інструменту:
		<br><input  type="number" id="D2">
    <br>
		<br>v,м/хв = швидкість головного руху різання, що допускається ріжучими властивостями свердла:
