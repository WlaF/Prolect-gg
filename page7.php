 ...
 ?>
  <div class="container-sm">
	...
	<fieldset>
		...
		Найбільша допустима сила подачі,кН, : 
		<br>
		<select id="Ft">
		...
		<br>
		<br>Швидкість переміщення, мм/хв: 
	...
	<br><p><b>ІІІ. ВИРАХОВУВАННЯ ПОТУЖНОСТІ ЕЛЕКТРОДВИГУНА НАСОСУ ОХОЛОДЖЕННЯ СВЕРДЛИЛЬНОГО ВЕРСТАТА</p></b>
	<br>
	<fieldset>
	<legend> КРОК 1. Вираховування потужності електродвигуна  насосу охолодження свердлильного верстата</legend>
 	<p>
   		<br>
   		$$
			\pmb{\frac{1.1⋅{Gama}⋅{Q}⋅{H}}{{3600}⋅{1000}⋅{KKD}⋅{M}}}
		$$
   	</p>
	Густина перекачуваної рідини, кг/см3:
	<br>
	<select  id="Gama">
	...
	<br>
	<br>Продуктивність насосу Q, Н/м:
	<br>
	<select  id="Q">
	...
	<br>
	<br>Коефіцієнт корисної дії насосу:
	<br>
	<select  id="KKD">
	...
	<br>
	<br>Коефіцієнт корисної дії передачі:
	<br>
	<select  id="M">
