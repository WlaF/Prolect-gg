  ...
  <br>
	...
	<p>
		<p>
   		<br>
   		$$
			\pmb{{Cm}⋅\left(\frac{75}{σ}\right)^{nv}}
		$$
   	</p>
	<p>Вираховування "першого" поправочного коефіцієнта Kmv</p> 
	<br>
	См = коефіцієнт , що враховує групу сталі:
	<br>
        <select  id="Cm">
 		...
 		<p>
 			<br>
			nv = показник степені у формулі вираховування поправочного коефіцієнта при операції свердління і розсвердлювання:
        <br><select id="Nv">
        ...
        <br>σ,МПа = межа міцності матеріалу заготовки, сігма: 
...
<p id="empty_formula3">
    ...
    <br><br>
   		...
   		<p>
			   <button  id="copyred_formula3" disabled="true">Скопіювати формулу</button>
		   </p>
      ...
      <br>Kuv = поправочний коефіцієнт,що враховує марку інструментального матеріалу: 
      	<br><select id="Kuv">
      ...
      <br>
      <br>Klv = поправочний коефіцієнт, на швидкість різання, що враховує вплив глибини оброблювального отвору: 
      		<br><select  id="Klv">
          ...
          <br>
      <br>Kmv = поправочний коефіцієнт, на швидкість головного руху різання: 
    ...
    <br>
   		...
   		<p>
			   <button  id="copyred_formula4" disabled="true">Скопіювати формулу</button>
		   </p>
