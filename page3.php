...
<p id="empty_formula3">
    ...
    <br><br>
   		...
   		<p>
			   <button  id="copyred_formula3" disabled="true">Скопіювати формулу</button><span id="show3">Скопійовано!</span>
		   </p>
    ...
    <br>
   		...
   		<p>
			   <button  id="copyred_formula4" disabled="true">Скопіювати формулу</button><span id="show4">Скопійовано!</span>
		   </p>
