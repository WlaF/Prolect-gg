 ...
 <div class="container-sm">
	...
	<p>
   	...
   	<p>
   		...
   		<br>
   		$$
   			\pmb{\left(\frac{σ}{75}\right)^{np}}
   		$$
   	</p>	
   	<p>
   		<br>σ = межа міцності матеріалу заготовки, сігма, МПа:<br><input type="number" name="" id="sigma">
   	</p>
   	<p>
   		<br>np = показник степені у формулі осьової складової сили різання:
...
<p>
   		<br>
   		$$
		   \pmb{(9.81⋅{Cp}⋅{D^{qp}}⋅{{So}^{yp}})⋅{Kp}}
		$$
   	</p>
   	<p>	
   		<br>Cp = коефіцієнт формули осьової складової сили різання, що залежить від властивостей матеріалу, який обробляється:
   	<br>
        <select  id="Sr">
   	...
   	<p>
   		<br>qp = показник степені формули осьової складової сили різання, що залежить від властивостей матеріалу, який обробляється:
        <br>
        <select  id="Qp">
        	<optgroup label="Обробка матеріалу сталь конструкційна і стальне лиття з межою міцності 750 Мпа шляхлом свердління">
   	...
   	<p>
   		<br>yp = показник степені формули осьової складової сили різання, що залежить від властивостей матеріалу, який обробляється:
   		<br>
   		<select  id="Yp">
        	<optgroup label="Обробка матеріалу сталь конструкційна і стальне лиття з межою міцності 750 Мпа шляхлом свердління">
      ...
      <br><input  type="number" id="D">
        ...
        <br><br>Kp = поправочний коефіцієнт на осьову складову сили різання:
